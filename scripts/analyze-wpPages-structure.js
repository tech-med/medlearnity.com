...
const CLASSIFICATIONS = {
  tutors: {
    ...
    patterns: [
      ...
      'dr-akshay-goel', 'eytan-palte', 'madeleine-basist', 'radhika-srivastava',
      'viemma-nwigwe', 'keith-cordner', 'melissa-wing', 'kush-patel',
      'ken-nakanote', 'victoria-lord', 'pranav-rekapalli', 'sylvia-rhodes',
      'lucy-wang', 'max-frankfurter', 'farid-ghamsari', 'keon-youssefzadeh',
      'robert-rosen', 'richard-wang', 'walid-ashmeik', 'sai-bhatte',
      'dani-brown', 'fawaz-naeem', 'daksh-chauhan', 'joseph-lu',
      'anna-chen', 'mimi-kim', 'justin-sardi', 'amit-syal', 'sarah-bell',
      'yehuda-elkaim', 'katherine-oakley', 'anthony'
    ],
    subcategories: {
      leadership: ['dr-akshay-goel'],
      'medical-doctors': [
        'eytan-palte', 'madeleine-basist', 'radhika-srivastava', 'viemma-nwigwe',
        'melissa-wing', 'kush-patel', 'ken-nakanote', 'richard-wang'
      ],
      'medical-students': [
        'victoria-lord', 'pranav-rekapalli', 'sylvia-rhodes', 'lucy-wang',
        'max-frankfurter', 'farid-ghamsari', 'keon-youssefzadeh', 'robert-rosen',
        'walid-ashmeik', 'sai-bhatte', 'dani-brown', 'fawaz-naeem',
        'daksh-chauhan', 'joseph-lu', 'anna-chen', 'mimi-kim', 'justin-sardi',
        'amit-syal', 'sarah-bell', 'yehuda-elkaim', 'keith-cordner', 'anthony'
      ]
    }
  },
  services: {
    ...
    patterns: [
      'professional-usmle-tutoring', 'medical-school-admissions', 'residency-admissions',
      'coursework', 'medical-remediation-tutoring', 'tutoring', 'admissions'
    ],
    subcategories: {
      tutoring: [
        'professional-usmle-tutoring', 'medical-remediation-tutoring', 'coursework', 'tutoring'
      ],
      admissions: [
        'medical-school-admissions', 'residency-admissions', 'admissions'
      ]
    }
  },
  exams: {
    ...
    patterns: [
      'usmle', 'usmle-tutoring-step-1', 'step-2ck-usmle', 'usmle-step-3',
      'failed-step-1-usmle-tutoring', 'comlex', 'comlex-1', 'level-2-ce-and-pe',
      'level-3', 'mcat', 'nbme-shelf-exams', 'conquer-mcat-get-into-medical'
    ],
    subcategories: {
      usmle: [
        'usmle', 'usmle-tutoring-step-1', 'step-2ck-usmle', 'usmle-step-3',
        'failed-step-1-usmle-tutoring', 'professional-usmle-step-2-tutoring',
        'medlearnity-usmle-2', 'usmletutoring', 'usmle-study-guide'
      ],
      comlex: [
        'comlex', 'comlex-1', 'level-2-ce-and-pe', 'level-3', 'comlex-tutoring'
      ],
      mcat: [
        'mcat', 'conquer-mcat-get-into-medical'
      ],
      'shelf-exams': [
        'nbme-shelf-exams'
      ]
  ...
  'specialty-boards': {
    ...
    patterns: [
      'residency-board-exams', 'abs-exams', 'abs-exams-2', 'abs-qualifying-certifying',
      'abs-certifying-exam', 'internal-medicine-boards', 'family-medicine-certification-exam-abfm',
      'abr-core-exam-tutoring', 'medlearnity-abr-core-exam-tutoring',
      'medlearnity-abs-exam-tutoring', 'absite-core-shop', 'qlearn-absite'
    ]
  },
  shop: {
    ...
    patterns: [
      'conquer-the-usmle-shop', 'radiology-core-shop', 'premed-shop',
      'absite-core-shop', 'conquer-the-usmle', 'conquer-the-usmle-2'
    ]
  },
  pages: {
    name: 'General Pages',
    ...
    patterns: [
      'about', 'our-services', 'our-tutors', 'start-here', 'student-testimonials',
      'frequently-asked-questions', 'choosemedlearnity'
    ]
  },
  marketing: {
    ...
    patterns: [
      'discounted-trial-session', 'discounted-trial-session-v2', 'speak-to-advisor',
      'test-speak-to-advisor', 'learn-more-via-email', 'test-learn-more-via-email',
      'how-can-we-assist-you', 'purchase-discounted-session', 'core-video-review',
      'cvr-ft-thank-you', 'ft-thank-you', 'lmve-thank-you', 'trial-reservation-thank-you',
      'radreview'
    ]
  },
  ecommerce: {
    ...
    patterns: [
      'cart', 'payment-confirmation', 'payment-failed', 'thanks',
      'competitor', 'apprentice-registration-page'
    ]
  },
  legal: {
    ...
    patterns: [
      'terms-and-conditions', 'privacy-policy', 'qlearn-terms-of-use'
    ]
  },
  admin: {
    ...
    patterns: [
      'sitemap', 'email-reviews', 'start-here-old-page', 'test-form',
      'testing', 'testing-2'
    ]
  }
};
...
function getWpPagesDirectories() {
  ...
  try {
    return fs.readdirSync(wpPagesPath, { withFileTypes: true })
  ...
  for (const [category, dirs] of Object.entries(categorizedDirs)) {
    ...
    for (const dir of dirs) {
      ...
      const targetPath = subcategory 
        ? `${category}/${subcategory}/${dir}`
        : `${category}/${dir}`;
      
      plan.commands.push(`mkdir -p src/content/wpPages/${category}${subcategory ? '/' + subcategory : ''}`);
...
function analyzeWpPagesStructure() {
  ...
  for (const [category, dirs] of Object.entries(categorized)) {
    ...
    for (const dir of dirs.sort()) {
      ...
      console.log(`  ${dir.padEnd(35)} | ${title.substring(0, 40).padEnd(40)} | ${words.toString().padStart(4)} words`);
    }
  }
  ...
  console.log('==================================================');
  console.log(`Total directories to reorganize: ${directories.length - (categorized.uncategorized?.length || 0)}`);
